                ...
                <div className="col-lg-4">
                    <div className="s-video-content">
                        <Link to="#" className="popup-video mb-50" onClick={() => setVideo(true)} >
                            <video src="assets/img/bg/play-button.png" alt="circle_right" onClick={() => setVideo(true)} />
                        </Link>
                    </div>
                </div>
                </div>
            ...
            <div className="mfp-container mfp-s-ready mfp-iframe-holder">
                <div className="mfp-content">
                    <div className="mfp-iframe-scaler">
                        ...
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/s1NUYdp3uew?si=o1YIOr5i2mME8ZkL" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
                        </div>
